---
description: Executes clearly scoped coding or inspection tasks with explicit
  allowed paths, success criteria, and minimal autonomy. Do not use for
  architecture, planning, or broad exploration.
mode: subagent
