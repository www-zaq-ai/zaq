...
defmodule ZaqWeb.Components.ChatMessage do
  ...
  defp source_href(source) when is_binary(source) do
    if String.ends_with?(source, ".md"),
      do: "/bo/preview/#{source}",
      else: "/bo/files/#{source}"
  end

  defp source_href(%{"id" => id}), do: "/bo/files/#{id}"
  defp source_href(_), do: "#"
