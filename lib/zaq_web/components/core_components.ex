defmodule ZaqWeb.CoreComponents do
  ...
  @doc """
  Provides system / light / dark theme control.

  Dispatches `phx:set-theme`; see `<head>` in `root.html.heex` which applies the
  theme before first paint and syncs `localStorage` (`phx:theme`).
  """
  def theme_toggle(assigns) do
    ~H"""
    <div class="zaq-toggle-group zaq-toggle-group-pill">
      <button
        type="button"
