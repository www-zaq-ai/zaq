defmodule ZaqWeb.Components.DesignSystem.PersonProfile do
  ...
  def person_profile(assigns) do
    ...
    >
      <div class="zaq-layout-stack min-w-0">
        <section aria-labelledby="information-heading">
          <CardShell.card_shell
            id="person-information-card"
            as={:div}
            class="zaq-card-hover zaq-layout-stack"
          >
      ...
      <section class="min-w-0" aria-labelledby="channels-heading">
        <CardShell.card_shell
          id="person-channels-card"
          as={:div}
          class="zaq-card-hover zaq-layout-stack min-w-0"
        >
