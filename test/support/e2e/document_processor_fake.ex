defmodule Zaq.E2E.DocumentProcessorFake do
  ...
  def read_as_markdown(file_path) do
    ...
    if sidecar_path && File.exists?(sidecar_path) do
      File.read(sidecar_path)
    else
      content = "# E2E Fake\n\nGenerated by DocumentProcessorFake for `#{file_path}`.\n"

      if sidecar_path, do: File.write!(sidecar_path, content)
  ...
  @impl true
  def store_chunk_with_metadata(_chunk, _document_id, _chunk_index), do: {:ok, nil}
