...
| `Zaq.Engine.Workflows.Step.Run` | Schema: per-step execution record (crash-safe cursor); DB table `workflow_action_results`; statuses: `running`, `completed`, `failed`, `skipped` |
