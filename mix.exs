defmodule Zaq.MixProject do
  ...
  defp deps do
    [
      ...
      # {:jido_chat, path: "../forks/jat10/jido_chat", override: true},
      {:jido_chat,
       github: "jat10/jido_chat", branch: "feat/fetch-media-callback", override: true},
      ...
      {:jido_chat_telegram,
       github: "jat10/jido_chat_telegram", branch: "feat/fetch-media-callback", override: true},
