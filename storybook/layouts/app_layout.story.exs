defmodule Storybook.Layouts.AppLayout do
  ...
  def description,
    do:
      "Root app layout shell — app/1 and flash_group/1 from ZaqWeb.Layouts; theme control lives in ZaqWeb.CoreComponents."
    ...
    <div style="font-family: var(--zaq-font-primary, monospace); padding: 2rem; display: flex; flex-direction: column; gap: 3rem; max-width: 800px;">
      <section>
        ...
        <p style="font-size: 0.8rem; opacity: 0.6; line-height: 1.6; margin-bottom: 1rem;">
          Top-level layout shell used for the public-facing and authentication flows. Wraps
          <code style="font-family: ui-monospace, monospace;">flash_group</code>
          and the page content. BO pages use
          <code style="font-family: ui-monospace, monospace;">BOLayout.bo_layout</code>
          instead.
        </p>
      ...
      <section>
        ...
        <p style="font-size: 0.8rem; opacity: 0.6; line-height: 1.6; margin-bottom: 1rem;">
          Renders a stack of flash messages from the Phoenix flash map. Used automatically inside <code style="font-family: ui-monospace, monospace;">app/1</code>. Do
          <strong>not</strong>
          add it manually inside BO templates —
          <code style="font-family: ui-monospace, monospace;">bo_layout</code>
          handles flash internally.
        </p>
