  ...
  def render(assigns) do
    ...
    <div style="font-family: var(--zaq-font-primary, sans-serif); padding: 2rem;">
      <div style="display: flex; flex-wrap: wrap; gap: 1.5rem;">
        <div :for={provider <- @providers} style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem; width: 80px;">
          ...
          <span style="font-family: ui-monospace, monospace; font-size: 0.6rem; opacity: 0.5; text-align: center; word-break: break-word;"><%= provider %></span>
        </div>
      </div>
    </div>
    """
